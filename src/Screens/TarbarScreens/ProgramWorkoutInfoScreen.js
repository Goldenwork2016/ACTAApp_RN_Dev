...
import { View, Text, Image, StyleSheet, FlatList, SafeAreaView, Platform, ImageBackground, ScrollView, TouchableOpacity, Modal } from 'react-native';
            ...
            <View style={styles.container}>
                ...
                <ScrollView style={{ width: '100%' }}>
                    ...
                    {/* <Modal isVisible={this.state.isModalVisible}>
                        <View style={{width:'80%', height:200, backgroundColor:'blackc'}}>
                            <TouchableOpacity>
                                <Text>Close</Text>
                            </TouchableOpacity>
                        </View>
